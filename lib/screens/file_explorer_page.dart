...
// import 'package:device_info_plus/device_info_plus.dart'; // Якщо є, краще перевіряти версію Android
...
class _FileExplorerPageState extends State<FileExplorerPage> {
  ...
  Future<void> _pickAndImportFiles() async {
    ...
    if (status.isPermanentlyDenied) {
      setState(() => _statusMessage = 'Дозвіл заблоковано! Відкрийте налаштування.');
      await openAppSettings();
      return;
    }
    if (!status.isGranted && !status.isLimited) {
       setState(() => _statusMessage = 'Потрібен дозвіл на читання файлів!');
       return;
    }
    setState(() {
      _isLoading = true;
      ...
      body: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Icon(Icons.audio_file, size: 100, color: Colors.deepPurple), // Змінив іконку для краси
